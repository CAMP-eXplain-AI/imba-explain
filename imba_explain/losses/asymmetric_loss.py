# Copied from https://github.com/open-mmlab/mmclassification/blob/master/mmcls/models/losses/asymmetric_loss.py
...
class AsymmetricLoss(nn.Module):
    ...
    def __init__(self, gamma_pos=0.0, gamma_neg=4.0, clip=0.05, reduction='mean', loss_weight=1.0):
